...
class NewsCrud
{
    ...
    public function setRepositoryApi(NewsApiInterface $newsApi)
    {
    ...
    public function update($id): CrudResponse
    {
        ...
        $newsInDatabase->publication_date = $this->getSubmitField('publication_date');
        ...
        $validator->isNotEmpty('publication_date', 'Vous devez remplir une date de publication');
    ...
    public function delete($id): CrudResponse
    {
        $newsInDatabase = $this->getRepositoryApi()->findById($id);
        ...
        $this->getRepositoryApi()->delete($id);
