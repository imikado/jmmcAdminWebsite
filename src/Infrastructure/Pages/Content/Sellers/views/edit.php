<?php $sellers = $this->contextList['sellers']; ?>
<h2>Modifier un Commerçant</h2>
    ...
    <form onsubmit="return loadWysiwigBefore()" class="col s12" method="POST">
        ...
        <div class="row">
            <div class="input-field col s12">
                <input value="<?php echo $sellers->title ?>" placeholder=" Le titre de l'actualité" id="title" name="title" type="text" class="validate">
        ...
        <div class="row">
            ...
            <div class="input-field col s4">
                ...
                <div class="switch">
                    <label>
                        Brouillon
                        <input <?php if ($sellers->status == 'published') : ?>checked<?php endif ?> name="active" type="checkbox">
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                ...
                <div contenteditable id="contentPreview"><?php echo $sellers->content ?></div>
