<?php $events = $this->contextList['events']; ?>
    ...
    <form onsubmit="return loadWysiwigBefore()" class="col s12" method="POST">
        ...
        <div class="row">
            <div class="input-field col s12">
                <input value="<?php echo $events->title ?>" placeholder=" Le titre de l'actualité" id="title" name="title" type="text" class="validate">
        ...
        <div class="row">
            ...
            <div class="input-field col s4">
                ...
                <div class="switch">
                    <label>
                        Brouillon
                        <input <?php if ($events->status == 'published') : ?>checked<?php endif ?> name="active" type="checkbox">
            ...
            <div class="input-field offset-s4 col s4">
                <input value="<?php echo $events->publication_date ?>" placeholder="La date de publication" id="publication_date" name="publication_date" type="text" class="datepicker">
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                ...
                <div contenteditable id="contentPreview"><?php echo $events->content ?></div>
