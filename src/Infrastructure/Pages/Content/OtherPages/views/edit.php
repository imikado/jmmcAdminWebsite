<?php $otherPages = $this->contextList['otherPages']; ?>
<h2>Modifier la page : <?php echo $otherPages->title ?> </h2>
    ...
    <form onsubmit="return loadWysiwigBefore()" class="col s12" method="POST">
        ...
        <div class="row">
            <div class="input-field col s12">
                <input readonly value="<?php echo $otherPages->filename ?>" placeholder=" Le nom de la page html" id="title" name="title" type="text" class="validate">
                <label for="title">Page HTML</label>
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                ...
                <div contenteditable id="contentPreview"><?php echo $otherPages->content ?></div>
